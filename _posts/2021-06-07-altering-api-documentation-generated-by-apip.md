...
In my older projects code, the decorated normalizer returned an array of `ArrayObject` instances instead of a multilayered array. If that is the case, you can
